...
<div class="p-4">
	...
	>
	<P class="mb-4"
		>If you want to be able to use LunaUI's style files along with your custom styles, you need to
	...
	>
	<P class="mb-4"
		>For example, to style text and fonts, refer to <A
...
:root {
	...
	--color-dropdown-active: var(--color-primary-400);
}`}
		showHeader={false}
